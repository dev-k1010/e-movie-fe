...
export default function DangKi() {
  ...
  const { errDangKi, dangKy } = useSelector(
    ...
    <section className="h-screen">
      <div className="lg:flex">
        <div className="lg:w-1/2 xl:max-w-screen-sm">
          <div
            className="mt-20 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl"
            style={{ marginTop: 50 }}
          >
            <h2
                ...
                <div>
                  ...
                  <input
                    ...
                    {...register("hoTen", {
                      ...
                      minLength: {
                        value: 6,
                        message: "User name bắt buộc từ 6 - 20 kí tự",
                      },
                      maxLength: { value: 20, message: "Không quá 20 kí tự!" },
                    })}
                  />
                  {errors?.hoTen?.message && (
                    <p className="text-red-400">{errors.hoTen.message}</p>
                  )}
                </div>
                <div className="mt-8">
                  ...
                  {errors?.taiKhoan?.message && (
                    <p className="text-red-400">{errors.taiKhoan.message}</p>
                  )}
                  <p className="m-0 text-red-500 h-7">
                    {errDangKi === "Tài khoản đã tồn tại!" ? errDangKi : ""}
                  </p>
                </div>
                <div className="mt-8">
                  <div className="flex justify-between items-center">
                  ...
                  <p className="m-0 text-red-500 h-7">
                    {errDangKi === "Email đã tồn tại!" ? errDangKi : ""}
                  </p>
                </div>
                <div className="mt-8">
                  <div className="flex justify-between items-center">
                  ...
                  />
                  {errors?.sdt?.message && (
                    <p className="text-red-400">{errors.sdt.message}</p>
                  )}
                </div>
                <div className="mt-8">
                  <div className="flex justify-between items-center">
                  ...
                  {errors?.matkhau?.message && (
                    <p className="text-red-400">{errors.matkhau.message}</p>
                  )}
                </div>
                <div className="mt-10">
                  <button
